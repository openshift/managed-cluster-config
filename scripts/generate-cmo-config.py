...
output_file_path_non_uwm_411_415 = os.path.join("deploy", "cluster-monitoring-config-non-uwm", "4.11-4.15", "50-GENERATED-cluster-monitoring-config.yaml")
...
output_file_path_uwm_411_415 = os.path.join("deploy", "cluster-monitoring-config", "4.11-4.15", "50-GENERATED-cluster-monitoring-config.yaml")
...
dump_configmap(input_file_path, output_file_path_uwm_411_415, True, False, "7d", True, True)
